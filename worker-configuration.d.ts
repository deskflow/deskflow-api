/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d215277e87112b3b06c645605c6f368b)
// Runtime types generated with workerd@1.20260921.1 2024-10-11 nodejs_compat
interface __BaseEnv_Env {
	APP_VERSION: KVNamespace;
	GITHUB_TOKEN: string;
	SlowKV: DurableObjectNamespace<import("./src/index").SlowKV>;
	VotesByIP: DurableObjectNamespace<import("./src/index").VotesByIP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SlowKV" | "VotesByIP";
	}
